...
import 'package:intikom_app/infrastructure/env/network_constants.dart';
import 'package:intikom_app/infrastructure/ext/map_ext.dart';
import 'package:intikom_app/infrastructure/types/exceptions/base_exception.dart';
import 'package:intikom_app/infrastructure/types/exceptions/form_exception.dart';
import 'package:intikom_app/infrastructure/types/exceptions/session_exception.dart';
import 'package:intikom_app/infrastructure/types/json.dart';
...
class UFClient implements APIClient {
  @override
  Future<APIResult<T>> post<T>(
      {required String path,
      required MapFromJSON<T> mapper,
